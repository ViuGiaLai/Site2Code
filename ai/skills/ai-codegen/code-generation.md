<!-- Source: https://skills.sh/aj-geddes/useful-ai-prompts/code-generation-template -->
<!-- Installed via: npx skills add aj-geddes/useful-ai-prompts@code-generation-template -->
---
