<!-- Source: https://skills.sh/sickn33/antigravity-awesome-skills/clean-code -->
<!-- Installed via: npx skills add sickn33/antigravity-awesome-skills@clean-code -->
---
name: clean-code
...
## 3. Comments
- **Don't Comment Bad Codeâ€”Rewrite It**: Most comments are a sign of failure to express ourselves in code.
