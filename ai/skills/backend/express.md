<!-- Source: https://skills.sh/aj-geddes/useful-ai-prompts/nodejs-express-server -->
<!-- Installed via: npx skills add aj-geddes/useful-ai-prompts@nodejs-express-server -->
---
