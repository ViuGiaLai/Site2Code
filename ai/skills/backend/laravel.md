<!-- Source: https://skills.sh/jeffallan/claude-skills/laravel-specialist -->
<!-- Installed via: npx skills add jeffallan/claude-skills@laravel-specialist -->
---
...
1. **Analyse requirements** â€” Identify models, relationships, APIs, and queue needs
2. **Design architecture** â€” Plan database schema, service layers, and job queues
3. **Implement models** â€” Create Eloquent models with relationships, scopes, and casts; run `php artisan make:model` and verify with `php artisan migrate:status`
4. **Build features** â€” Develop controllers, services, API resources, and jobs; run `php artisan route:list` to verify routing
5. **Test thoroughly** â€” Write feature and unit tests; run `php artisan test` before considering any step complete (target >85% coverage)
...
final class Post extends Model
{
    ...
    // Relationships â€” always eager-load via ::with() at call site
...
final class PublishPost implements ShouldQueue
{
    ...
    {
        // Log or notify â€” never silently swallow failures
